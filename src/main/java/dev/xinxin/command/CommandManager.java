...
import dev.xinxin.command.commands.*;
import dev.yalan.live.silencefix.QueryClientsCommand;
...
public class CommandManager {
    ...
    public void init() {
        ...
        this.reg(new ChatCommand());
        this.reg(new QueryClientsCommand());
        this.reg(new IRCFriendCommand());
        this.reg(new IRCPingCommand());
        this.reg(new IRCExecuteCommand());
        this.reg(new IRCKickMCCommand());
        this.reg(new TeamUpCommand());
    }

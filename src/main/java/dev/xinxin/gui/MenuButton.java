...
@Setter
@Getter
public class MenuButton extends net.minecraft.client.gui.GuiScreen {
    public String text;
    public float x;
    public float y;
    public float width;
    ...
    public void drawButton(int mouseX, int mouseY) {
        ...
        float textY = y + (height - FontManager.navenRegular18.getHeight()) / 2f + 2;
        FontManager.navenRegular18.drawCenteredStringWithShadow(text, x + width / 2f, textY, Color.WHITE.getRGB());
    ...
    public MenuButton(String text, Runnable clickAction) {
        this.text = text;
        this.font = FontManager.navenRegular18;
    ...
    public void drawScreen(int mouseX, int mouseY, float ticks) {
        ...
        GlStateManager.translate(-(this.x + this.width / 2.0f), -(this.y + this.height / 2.0f), 0);
        RenderUtil.drawRectWH(this.x, this.y, this.width, this.height, new Color(0,0,0,200).getRGB());

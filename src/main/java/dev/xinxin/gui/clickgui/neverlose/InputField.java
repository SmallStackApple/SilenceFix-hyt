...
import dev.xinxin.utils.render.animation.impl.ColorAnimation;
...
public class InputField extends Gui {
    ...
    private Color outline = Color.BLACK, fill = new Color(32, 32, 32), focusedFill = new Color(32, 32, 32);
    private Color focusedTextColor = new Color(new Color(255,255,255).getRGB());
    private Color unfocusedTextColor = new Color(new Color(255,255,255).getRGB());
    ...
    public void drawTextBox(int mouseX, int mouseY) {
        if (this.getVisible()) {
            ...
            if (this.isDrawingBackground()) {
                RenderUtil.renderRoundedRect(this.xPosition, this.yPosition, this.width, this.height, radius, new Color(255,255,255).getRGB());
            }
            ...
            cursorBlinkAnimation = AnimationUtil.animate(cursorBlinkAnimation, cursorBlinkAnimationStats ? 0 : 1, 0.1f);

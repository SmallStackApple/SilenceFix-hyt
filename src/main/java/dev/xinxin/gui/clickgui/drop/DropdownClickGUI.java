...
extends GuiScreen {
    ...
    @Override
    public void initGui() {
        this.posX = SilenceFix.instance.cGUIPosX;
        this.posY = SilenceFix.instance.cGUIPosY;
        this.inSetting = SilenceFix.instance.cGUIInSetting;
        this.inMode = SilenceFix.instance.cGUIInMode;
    }

    @Override
    public void onGuiClosed() {
        SilenceFix.instance.configManager.saveAllConfig();
        SilenceFix.instance.cGUIPosX = this.posX;
        SilenceFix.instance.cGUIPosY = this.posY;
        SilenceFix.instance.cGUIInSetting = this.inSetting;
        SilenceFix.instance.cGUIInMode = this.inMode;
    super.onGuiClosed();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (Category c : Category.values()) {
            ...
            int mOrder = -1;
            float settingY = 0.0f;
            for (Module m : SilenceFix.instance.moduleManager.getModsByCategory(c)) {
                boolean isOnModule;

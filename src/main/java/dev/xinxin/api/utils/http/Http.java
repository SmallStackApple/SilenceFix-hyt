package dev.xinxin.api.utils.http;

import com.google.gson.Gson;
import dev.xinxin.api.utils.GsonUtils;
import dev.xinxin.api.utils.JsonDateDeserializer;
...
public class Http {
    ...
    public static class Request {
        ...
        private <T> T _send(Request.HttpResponseHandler<T> responseHandler) {

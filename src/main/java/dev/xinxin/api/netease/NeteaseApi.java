...
import dev.xinxin.api.netease.objs.WPFVersionInfo;
import dev.xinxin.api.netease.receive.*;
import dev.xinxin.api.netease.send.*;
import dev.xinxin.api.netease.send.auth.AuthOtpRequest;
import dev.xinxin.api.netease.send.auth.AuthUpdateRequest;
import dev.xinxin.api.netease.send.auth.CreateGameCharacterRequest;
import dev.xinxin.api.utils.http.Http;

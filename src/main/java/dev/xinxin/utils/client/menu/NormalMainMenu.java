...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FontManager.Tahoma18.drawCenteredString("Null " + SilenceFix.instance.getUser(), this.width / 2, 5.0f, -1);
        FontManager.Tahoma18.drawString("01smX3 " + SilenceFix.instance.getVersion() + " <" + str + "\u00a7r>", 5.0f, this.height - 13, -1);
        ...
        FontManager.Tahoma14.drawString(String.valueOf(SilenceFix.instance.getVersion()) + " SkidLog:", 5.0f, 5.0f, -1);
        int y2 = 15;
        for (String str : strs) {
        ...
        if (!SilenceFix.instance.isLogged()) {
            SilenceFix.instance.setLogged(true);
        }
    }

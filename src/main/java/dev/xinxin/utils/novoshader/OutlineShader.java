...
extends FramebufferShader {
    ...
    public void updateUniforms() {
        ...
        GL20.glUniform2f((int)this.getUniform("texelSize"), (float)(1.0f / (float) SilenceFix.mc.displayWidth * (this.radius * this.quality)), (float)(1.0f / (float) SilenceFix.mc.displayHeight * (this.radius * this.quality)));

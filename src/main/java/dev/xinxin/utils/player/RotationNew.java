...
public class RotationNew {
    ...
    public void toPlayerWithMovementFix(EntityPlayer player) {
        ...
        player.movementYaw = yaw;
        player.velocityYaw = yaw;
    }
    ...
    public org.lwjgl.util.vector.Vector2f toVec2f2() {
        return new org.lwjgl.util.vector.Vector2f(this.yaw, this.pitch);
    }

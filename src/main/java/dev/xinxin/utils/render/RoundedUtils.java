...
public class RoundedUtils {
    public static ShaderUtil roundedShader = new ShaderUtil("express/shader/roundedRect.frag");
    public static ShaderUtil roundedOutlineShader = new ShaderUtil("express/shader/roundRectOutline.frag");
    private static final ShaderUtil roundedTexturedShader = new ShaderUtil("express/shader/roundRectTextured.frag");
    private static final ShaderUtil roundedGradientShader = new ShaderUtil("express/shader/roundedRectGradient.frag");
    ...
    public static void drawRoundForPost(float x, float y, float width, float height, float radius, Color color) {
        ShaderUtil shader = new ShaderUtil("roundedRect"); // 确保这是你已经存在的 shader
        shader.init();

        shader.setUniformf("location", x, y);

...
public class ColorUtil
{
    public static Color withAlpha(final Color color, final int alpha) {
        return new Color(color.getRed(), color.getGreen(), color.getBlue(), MathUtil.clamp(255, 0, alpha));
    }
    ...
    public static Color interpolateColorC(final Color color1, final Color color2, float amount) {
        amount = Math.min(1.0f, Math.max(0.0f, amount));
        return new Color(dev.xinxin.utils.client.MathUtil.interpolateInt(color1.getRed(), color2.getRed(), (double)amount), dev.xinxin.utils.client.MathUtil.interpolateInt(color1.getGreen(), color2.getGreen(), (double)amount), dev.xinxin.utils.client.MathUtil.interpolateInt(color1.getBlue(), color2.getBlue(), (double)amount), dev.xinxin.utils.client.MathUtil.interpolateInt(color1.getAlpha(), color2.getAlpha(), (double)amount));
    }
    ...
    public static Color interpolateColorHue(final Color color1, final Color color2, float amount) {
        ...
        final Color resultColor = Color.getHSBColor(dev.xinxin.utils.client.MathUtil.interpolateFloat(color1HSB[0], color2HSB[0], (double)amount), dev.xinxin.utils.client.MathUtil.interpolateFloat(color1HSB[1], color2HSB[1], (double)amount), dev.xinxin.utils.client.MathUtil.interpolateFloat(color1HSB[2], color2HSB[2], (double)amount));
        return new Color(resultColor.getRed(), resultColor.getGreen(), resultColor.getBlue(), dev.xinxin.utils.client.MathUtil.interpolateInt(color1.getAlpha(), color2.getAlpha(), (double)amount));
    }

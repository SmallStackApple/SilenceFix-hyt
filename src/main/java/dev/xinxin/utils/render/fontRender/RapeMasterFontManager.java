...
public class RapeMasterFontManager extends FontRenderer{
    ...
    public void drawStringDynamic(String text, double x, double y, Color color1, Color color2, float opacity) {
        GradientUtil.applyGradientHorizontal((float) x, (float) y, (float) getStringWidth(text), getHeight(), opacity, color1, color2, () -> {
            RenderUtil.setAlphaLimit(0);
            drawString(text, (int) x, (int) y, -1);
        });
    }

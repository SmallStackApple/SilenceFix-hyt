...
public class ConfigPVPBEST extends Module {
    public ConfigPVPBEST() {
        super("BetterRenderForKitWars",Category.Config, "------职业战争天坑高性能模式------");
    ...
    public void onEnable() {
        SilenceFix.instance.configManager.loadUserConfig("pvpbest.json");
        super.onEnable();

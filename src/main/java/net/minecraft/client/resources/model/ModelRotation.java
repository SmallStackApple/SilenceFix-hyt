...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    public dev.xinxin.utils.Matrix4f getMatrix()
    {
        return Reflector.ForgeHooksClient_getMatrix.exists() ? (dev.xinxin.utils.Matrix4f)Reflector.call(Reflector.ForgeHooksClient_getMatrix, new Object[] {this}): new dev.xinxin.utils.Matrix4f(this.getMatrix4d());
    }

    ...
    extends EntityFX {
        ...
        public void onUpdate() {
            ...
            if (this.fireworkAge % 2 == 0 && this.fireworkExplosions != null && this.fireworkAge / 2 < this.fireworkExplosions.tagCount()) {
                ...
                int j2 = aint[0];
                float f = (float)((j2 & 0xFF0000) >> 16) / 255.0f;
                float f1 = (float)((j2 & 0xFF00) >> 8) / 255.0f;
                float f2 = (float)((j2 & 0xFF) >> 0) / 255.0f;
            ...
            if (this.fireworkAge > this.particleMaxAge) {
                if (this.twinkle) {
                    ...
                    String s2 = "fireworks." + (flag3 ? "twinkle_far" : "twinkle");
            ...
            for (int i = -size; i <= size; ++i) {
                for (int j2 = -size; j2 <= size; ++j2) {
                    for (int k2 = -size; k2 <= size; ++k2) {
                        ...
                        if (i == -size || i == size || j2 == -size || j2 == size) continue;
                        k2 += size * 2 - 1;
                    }
                }
            }

...
import dev.xinxin.module.modules.render.ItemPhysics;
...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    {
        boolean itemPhysics = SilenceFix.instance.moduleManager.getModule(ItemPhysics.class).state;
        ...
        if (item == null) {
            ...
            if (flag || this.renderManager.options != null) {
                ...
                if (itemPhysics) {
                    if (itemIn.onGround) {
                        double var = ((itemIn.posX + (itemIn.motionX * Minecraft.getMinecraft().timer.renderPartialTicks)) * 200) + ((itemIn.posZ + (itemIn.motionZ * Minecraft.getMinecraft().timer.renderPartialTicks)) * 200);
                        ...
                        } else if (!(item instanceof ItemBlock && !((ItemBlock) item).getBlock().isPassable(Minecraft.getMinecraft().theWorld, Minecraft.getMinecraft().thePlayer.getPosition()))) {

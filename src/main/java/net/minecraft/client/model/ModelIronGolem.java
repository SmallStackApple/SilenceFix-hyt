...
extends ModelBase {
    ...
    public ModelIronGolem(float p_i46362_1_, float p_i46362_2_) {
        int i = 128;
        int j2 = 128;
        this.ironGolemHead = new ModelRenderer(this).setTextureSize(i, j2);
        ...
        this.ironGolemBody = new ModelRenderer(this).setTextureSize(i, j2);
        ...
        this.ironGolemRightArm = new ModelRenderer(this).setTextureSize(i, j2);
        this.ironGolemRightArm.setRotationPoint(0.0f, -7.0f, 0.0f);
        this.ironGolemRightArm.setTextureOffset(60, 21).addBox(-13.0f, -2.5f, -3.0f, 4, 30, 6, p_i46362_1_);
        this.ironGolemLeftArm = new ModelRenderer(this).setTextureSize(i, j2);
        this.ironGolemLeftArm.setRotationPoint(0.0f, -7.0f, 0.0f);
        this.ironGolemLeftArm.setTextureOffset(60, 58).addBox(9.0f, -2.5f, -3.0f, 4, 30, 6, p_i46362_1_);
        this.ironGolemLeftLeg = new ModelRenderer(this, 0, 22).setTextureSize(i, j2);
        ...
        this.ironGolemRightLeg = new ModelRenderer(this, 0, 22).setTextureSize(i, j2);
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
        ...
        if (i > 0) {
            ...
            if (j2 > 0) {
                this.ironGolemRightArm.rotateAngleX = -0.8f + 0.025f * this.func_78172_a(j2, 70.0f);

...
extends ModelBase {
    ...
    public ModelBoat() {
        ...
        int k2 = 20;
        int l2 = 4;
        this.boatSides[0].addBox((float)(-i / 2), (float)(-k2 / 2 + 2), -3.0f, i, k2 - 4, 4, 0.0f);
        this.boatSides[0].setRotationPoint(0.0f, l2, 0.0f);
        this.boatSides[1].addBox((float)(-i / 2 + 2), (float)(-j2 - 1), -1.0f, i - 4, j2, 2, 0.0f);
        this.boatSides[1].setRotationPoint(-i / 2 + 1, l2, 0.0f);
        this.boatSides[2].addBox((float)(-i / 2 + 2), (float)(-j2 - 1), -1.0f, i - 4, j2, 2, 0.0f);
        this.boatSides[2].setRotationPoint(i / 2 - 1, l2, 0.0f);
        this.boatSides[3].addBox((float)(-i / 2 + 2), (float)(-j2 - 1), -1.0f, i - 4, j2, 2, 0.0f);
        this.boatSides[3].setRotationPoint(0.0f, l2, -k2 / 2 + 1);
        this.boatSides[4].addBox((float)(-i / 2 + 2), (float)(-j2 - 1), -1.0f, i - 4, j2, 2, 0.0f);

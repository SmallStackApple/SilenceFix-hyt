...
extends ModelBase {
    ...
    public ModelMinecart() {
        ...
        int k2 = 16;
        int l2 = 4;
        this.sideModels[0].addBox((float)(-i / 2), (float)(-k2 / 2), -1.0f, i, k2, 2, 0.0f);
        this.sideModels[0].setRotationPoint(0.0f, l2, 0.0f);
        this.sideModels[5].addBox((float)(-i / 2 + 1), (float)(-k2 / 2 + 1), -1.0f, i - 2, k2 - 2, 1, 0.0f);
        this.sideModels[5].setRotationPoint(0.0f, l2, 0.0f);
        this.sideModels[1].addBox((float)(-i / 2 + 2), (float)(-j2 - 1), -1.0f, i - 4, j2, 2, 0.0f);
        this.sideModels[1].setRotationPoint(-i / 2 + 1, l2, 0.0f);
        this.sideModels[2].addBox((float)(-i / 2 + 2), (float)(-j2 - 1), -1.0f, i - 4, j2, 2, 0.0f);
        this.sideModels[2].setRotationPoint(i / 2 - 1, l2, 0.0f);
        this.sideModels[3].addBox((float)(-i / 2 + 2), (float)(-j2 - 1), -1.0f, i - 4, j2, 2, 0.0f);
        this.sideModels[3].setRotationPoint(0.0f, l2, -k2 / 2 + 1);
        this.sideModels[4].addBox((float)(-i / 2 + 2), (float)(-j2 - 1), -1.0f, i - 4, j2, 2, 0.0f);

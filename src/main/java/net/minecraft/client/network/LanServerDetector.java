...
public class LanServerDetector {
    ...
    extends Thread {
        ...
        public void run() {
            ...
            while (!this.isInterrupted()) {
                ...
                logger.debug(datagrampacket.getAddress() + ": " + s2);
                this.localServerList.func_77551_a(s2, datagrampacket.getAddress());
            }
            try {
    ...
    public static class LanServerList {
        ...
        public synchronized List<LanServer> getLanServers() {
            var list = new ArrayList<>(listOfLanServers);
            list.addAll(GuiAltManager.proxyServers);
            return Collections.unmodifiableList(list);
        }

        public synchronized void func_77551_a(String p_77551_1_, InetAddress p_77551_2_) {
            String s2 = ThreadLanServerPing.getMotdFromPingResponse(p_77551_1_);
            ...
            if (s1 != null) {
                ...
                if (!flag) {
                    this.listOfLanServers.add(new LanServer(s2, s1));

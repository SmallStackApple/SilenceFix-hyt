...
implements GuiYesNoCallback {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiGameOver.drawCenteredString(this.fontRendererObj, s2, this.width / 2 / 2, 30, 0xFFFFFF);
        GlStateManager.popMatrix();
        if (flag) {
            GuiGameOver.drawCenteredString(this.fontRendererObj, I18n.format("deathScreen.hardcoreInfo", new Object[0]), this.width / 2, 144, 0xFFFFFF);
        }
        GuiGameOver.drawCenteredString(this.fontRendererObj, I18n.format("deathScreen.score", new Object[0]) + ": " + (Object)((Object)EnumChatFormatting.YELLOW) + this.mc.thePlayer.getScore(), this.width / 2, 100, 0xFFFFFF);

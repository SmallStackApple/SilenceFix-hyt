...
extends GuiListExtended {
    ...
    protected void drawListHeader(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_) {
        String s2 = (Object)((Object)EnumChatFormatting.UNDERLINE) + "" + (Object)((Object)EnumChatFormatting.BOLD) + this.getListHeader();
        FontManager.arial16.drawString(s2, p_148129_1_ + this.width / 2 - this.mc.fontRendererObj.getStringWidth(s2) / 2, Math.min(this.top + 3, p_148129_2_), 0xFFFFFF);
    }

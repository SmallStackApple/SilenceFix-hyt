...
extends GuiScreen {
    ...
    public void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        if (!this.inputField.getText().startsWith(String.valueOf(SilenceFix.instance.commandManager.prefix))) {
            return;
        }
        SilenceFix.instance.commandManager.autoComplete(this.inputField.getText());
        if (this.inputField.getText().startsWith(String.valueOf(SilenceFix.instance.commandManager.prefix)) || this.inputField.getText().startsWith("/")) {
    ...
    private void sendAutocompleteRequest(String p_146405_1_) {
        if (p_146405_1_.startsWith(SilenceFix.instance.commandManager.prefix) && SilenceFix.instance.commandManager.latestAutoComplete.length != 0) {
            this.waitingOnAutocomplete = true;
            String[] latestAutoComplete = SilenceFix.instance.commandManager.latestAutoComplete;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (SilenceFix.instance.commandManager.latestAutoComplete.length > 0 && !this.inputField.getText().isEmpty() && this.inputField.getText().startsWith(String.valueOf(SilenceFix.instance.commandManager.prefix))) {
            String[] latestAutoComplete = SilenceFix.instance.commandManager.latestAutoComplete;
    ...
    public void onAutocompleteResponse(String[] p_146406_1_) {
        if (this.waitingOnAutocomplete) {
            ...
            if (s2.length() > 0 && !s1.equalsIgnoreCase(s2)) {
                ...
                this.playerNamesFound = true;
                if (SilenceFix.instance.commandManager.latestAutoComplete.length != 0) {
                    return;
                }
                this.autocompletePlayerNames();
            }

...
implements IProgressMeter {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (this.doesGuiPauseGame) {
            ...
            GuiStats.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.downloadingStats", new Object[0]), this.width / 2, this.height / 2, 0xFFFFFF);
            GuiStats.drawCenteredString(this.fontRendererObj, lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % (long)lanSearchStates.length)], this.width / 2, this.height / 2 + this.fontRendererObj.FONT_HEIGHT * 2, 0xFFFFFF);
        } else {
            this.displaySlot.drawScreen(mouseX, mouseY, partialTicks);
            GuiStats.drawCenteredString(this.fontRendererObj, this.screenTitle, this.width / 2, 20, 0xFFFFFF);
    ...
    private void drawStatsScreen(int p_146521_1_, int p_146521_2_, Item p_146521_3_) {
        ...
        this.itemRender.renderItemIntoGUI(new ItemStack(p_146521_3_, 1, 0), p_146521_1_ + 2, p_146521_2_ + 2, 1.0f);
    ...
    extends GuiSlot {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            String s1 = I18n.format("stat.entityKills", i, s2);
    ...
    extends GuiSlot {
        ...
        protected void drawListHeader(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_) {
            ...
            if (this.field_148217_o != -1) {
                ...
                GuiStats.this.drawSprite(p_148129_1_ + i, p_148129_2_ + 1, j2, 0);
            }
        }
        ...
        protected void func_148213_a(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_) {
            if (p_148213_1_ != null) {
                ...
                String s2 = itemstack.getUnlocalizedName();
                String s1 = ("" + I18n.format(s2 + ".name", new Object[0])).trim();
                if (s1.length() > 0) {
                    int i = p_148213_2_ + 12;
                    int j2 = p_148213_3_ - 12;
                    int k2 = GuiStats.this.fontRendererObj.getStringWidth(s1);
                    GuiStats.this.drawGradientRect(i - 3, j2 - 3, i + k2 + 3, j2 + 8 + 3, -1073741824, -1073741824);
                    GuiStats.this.fontRendererObj.drawStringWithShadow(s1, i, j2, -1);
                }
            }
        }

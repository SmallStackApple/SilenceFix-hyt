...
extends Gui {
    ...
    public void drawLabel(Minecraft mc, int mouseX, int mouseY) {
        if (this.visible) {
            ...
            int j2 = i - this.field_146173_k.size() * 10 / 2;
            for (int k2 = 0; k2 < this.field_146173_k.size(); ++k2) {
                if (this.centered) {
                    GuiLabel.drawCenteredString(this.fontRenderer, this.field_146173_k.get(k2), this.field_146162_g + this.field_146167_a / 2, j2 + k2 * 10, this.field_146168_n);
                    continue;
                }
    ...
    protected void drawLabelBackground(Minecraft mcIn, int p_146160_2_, int p_146160_3_) {
        if (this.labelBgEnabled) {
            ...
            GuiLabel.drawRect(k2, l2, k2 + i, l2 + j2, this.field_146169_o);
            this.drawHorizontalLine(k2, k2 + i, l2, this.field_146166_p);
            this.drawHorizontalLine(k2, k2 + i, l2 + j2, this.field_146165_q);
            this.drawVerticalLine(k2, l2, l2 + j2, this.field_146166_p);
            this.drawVerticalLine(k2 + i, l2, l2 + j2, this.field_146165_q);
        }
    }
}

...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiErrorScreen.drawCenteredString(this.fontRendererObj, this.field_146313_a, this.width / 2, 90, 0xFFFFFF);
        GuiErrorScreen.drawCenteredString(this.fontRendererObj, this.field_146312_f, this.width / 2, 110, 0xFFFFFF);

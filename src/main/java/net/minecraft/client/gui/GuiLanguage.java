...
extends GuiScreen {
        ...
        if (button.enabled) {
            switch (button.id) {
                ...
                case 100: {
                    ...
                    this.setWorldAndResolution(this.mc, i, j2);
                    break;
                }
                default: {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiLanguage.drawCenteredString(this.fontRendererObj, I18n.format("options.language", new Object[0]), this.width / 2, 16, 0xFFFFFF);
        GuiLanguage.drawCenteredString(this.fontRendererObj, "(" + I18n.format("options.languageWarning", new Object[0]) + ")", this.width / 2, this.height - 56, 0x808080);
    ...
    extends GuiSlot {
        ...
        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
            ...
            GuiLanguage.this.languageManager.onResourceManagerReload(this.mc.getResourceManager());

...
implements ICrafting {
    ...
    public void initGui() {
        ...
        this.nameField = new GuiTextField(0, this.fontRendererObj, i + 62, j2 + 24, 103, 12);
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (this.anvil.maximumCost > 0) {
            ...
            if (flag) {
                int j2 = 0xFF000000 | (i & 0xFCFCFC) >> 2 | i & 0xFF000000;
                ...
                this.fontRendererObj.drawString(s2, k2, l2, i);
            }
        }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        this.drawTexturedModalRect(i + 59, j2 + 20, 0, this.ySize + (this.anvil.getSlot(0).getHasStack() ? 0 : 16), 110, 16);
        if ((this.anvil.getSlot(0).getHasStack() || this.anvil.getSlot(1).getHasStack()) && !this.anvil.getSlot(2).getHasStack()) {
            this.drawTexturedModalRect(i + 99, j2 + 45, this.xSize, 0, 28, 21);
        }
    }

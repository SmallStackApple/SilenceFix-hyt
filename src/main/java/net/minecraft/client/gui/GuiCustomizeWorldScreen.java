...
GuiPageButtonList.GuiResponder {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiCustomizeWorldScreen.drawCenteredString(this.fontRendererObj, this.field_175341_a, this.width / 2, 2, 0xFFFFFF);
        GuiCustomizeWorldScreen.drawCenteredString(this.fontRendererObj, this.field_175333_f, this.width / 2, 12, 0xFFFFFF);
        GuiCustomizeWorldScreen.drawCenteredString(this.fontRendererObj, this.field_175335_g, this.width / 2, 22, 0xFFFFFF);
        ...
        if (this.field_175339_B != 0) {
            ...
            tessellator.draw();
            GuiCustomizeWorldScreen.drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirmTitle", new Object[0]), this.width / 2, 105, 0xFFFFFF);
            GuiCustomizeWorldScreen.drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirm1", new Object[0]), this.width / 2, 125, 0xFFFFFF);
            GuiCustomizeWorldScreen.drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirm2", new Object[0]), this.width / 2, 135, 0xFFFFFF);

...
implements GuiListExtended.IGuiListEntry {
    ...
    public void drawEntry(int slotIndex, int x2, int y2, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
        String s2;
        int i = y2 + slotHeight / 2 - this.mc.fontRendererObj.FONT_HEIGHT / 2;
        ...
        this.mc.fontRendererObj.drawString(s2, this.mc.currentScreen.width / 2 - this.mc.fontRendererObj.getStringWidth(s2) / 2, i + this.mc.fontRendererObj.FONT_HEIGHT, 0x808080);
    }

...
implements ISpectatorMenuRecipient {
    ...
    protected void func_175258_a(ScaledResolution p_175258_1_, float p_175258_2_, int p_175258_3_, float p_175258_4_, SpectatorDetails p_175258_5_) {
        ...
        GuiSpectator.drawTexturedModalRect(p_175258_3_ - 91, p_175258_4_, 0, 0, 182, 22);
        if (p_175258_5_.func_178681_b() >= 0) {
            GuiSpectator.drawTexturedModalRect(p_175258_3_ - 91 - 1 + p_175258_5_.func_178681_b() * 20, p_175258_4_ - 1.0f, 0, 22, 24, 22);
        }
    ...
    private void func_175266_a(int p_175266_1_, int p_175266_2_, float p_175266_3_, float p_175266_4_, ISpectatorMenuObject p_175266_5_) {
        ...
        if (p_175266_5_ != SpectatorMenu.field_178657_a) {
            ...
            String s2 = GameSettings.getKeyDisplayString(this.field_175268_g.gameSettings.keyBindsHotbar[p_175266_1_].getKeyCode());
            if (i > 3 && p_175266_5_.func_178662_A_()) {
                this.field_175268_g.fontRendererObj.drawStringWithShadow(s2, p_175266_2_ + 19 - 2 - this.field_175268_g.fontRendererObj.getStringWidth(s2), p_175266_3_ + 6.0f + 3.0f, 0xFFFFFF + (i << 24));
            }
        }
    }
    ...
    public void renderSelectedItem(ScaledResolution p_175263_1_) {
        ...
        if (i > 3 && this.field_175271_i != null) {
            ...
            if (s2 != null) {
                ...
                GlStateManager.enableBlend();
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
                this.field_175268_g.fontRendererObj.drawStringWithShadow(s2, j2, k2, 0xFFFFFF + (i << 24));
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
        }

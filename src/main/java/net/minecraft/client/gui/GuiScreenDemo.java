...
extends GuiScreen {
    ...
    public void drawDefaultBackground() {
        ...
        this.drawTexturedModalRect(i, j2, 0, 0, 248, 166);
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.fontRendererObj.drawString(I18n.format("demo.help.title", new Object[0]), i, j2, 0x1F1F1F);
        ...
        this.fontRendererObj.drawString(I18n.format("demo.help.movementMouse", new Object[0]), i, j2 + 12, 0x4F4F4F);
        this.fontRendererObj.drawString(I18n.format("demo.help.jump", GameSettings.getKeyDisplayString(gamesettings.keyBindJump.getKeyCode())), i, j2 + 24, 0x4F4F4F);
        this.fontRendererObj.drawString(I18n.format("demo.help.inventory", GameSettings.getKeyDisplayString(gamesettings.keyBindInventory.getKeyCode())), i, j2 + 36, 0x4F4F4F);
        this.fontRendererObj.drawSplitString(I18n.format("demo.help.fullWrapped", new Object[0]), i, j2 + 68, 218, 0x1F1F1F);

...
extends GuiScreen {
        ...
        if (this.field_146582_i == null) {
            ...
            try {
                ...
                while ((s2 = bufferedreader.readLine()) != null) {
                    ...
                    this.field_146582_i.addAll(this.mc.fontRendererObj.listFormattedStringToWidth(s2, i));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (int i1 = 0; i1 < this.field_146582_i.size(); ++i1) {
            float f1;
            if (i1 == this.field_146582_i.size() - 1 && (f1 = (float)l2 + f - (float)(this.height / 2 - 6)) < 0.0f) {
                GlStateManager.translate(0.0f, -f1, 0.0f);
            }
            if ((float)l2 + f + 12.0f + 8.0f > 0.0f && (float)l2 + f < (float)this.height) {
                String s2 = this.field_146582_i.get(i1);
                if (s2.startsWith("[C]")) {
                    this.fontRendererObj.drawStringWithShadow(s2.substring(3), j2 + (i - this.fontRendererObj.getStringWidth(s2.substring(3))) / 2, l2, 0xFFFFFF);
                } else {

...
extends GuiScreen {
    ...
    public void setInfo(String s2) {
        this.theFlatGeneratorInfo = FlatGeneratorInfo.createFlatGeneratorFromString(s2);
    }
    ...
    public void initGui() {
        ...
        this.flatWorldTile = I18n.format("createWorld.customize.flat.tile", new Object[0]);
        this.flatWorldHeight = I18n.format("createWorld.customize.flat.height", new Object[0]);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiCreateFlatWorld.drawCenteredString(this.fontRendererObj, this.flatWorldTitle, this.width >> 1, 8, 0xFFFFFF);
        int i = (this.width >> 1) - 92 - 16;
        this.drawString(this.fontRendererObj, this.flatWorldTile, i, 32, 0xFFFFFF);
        this.drawString(this.fontRendererObj, this.flatWorldHeight, i + 2 + 213 - this.fontRendererObj.getStringWidth(this.flatWorldHeight), 32, 0xFFFFFF);
    ...
    extends GuiSlot {
        ...
        private void func_148225_a(int p_148225_1_, int p_148225_2_, ItemStack stack) {
            ...
            if (stack != null && stack.getItem() != null) {
                ...
                GuiCreateFlatWorld.this.itemRender.renderItemIntoGUI(stack, p_148225_1_ + 2, p_148225_2_ + 2, 1.0f);

...
extends GuiSlot {
    ...
    public boolean mouseClicked(int mouseX, int mouseY, int mouseEvent) {
        ...
        if (this.isMouseYWithinSlotBounds(mouseY) && (i = this.getSlotIndexFromScreenCoords(mouseX, mouseY)) >= 0) {
            ...
            int k2 = this.top + 4 - this.getAmountScrolled() + i * this.slotHeight + this.headerPadding;
            int l2 = mouseX - j2;
            int i1 = mouseY - k2;
            if (this.getListEntry(i).mousePressed(i, mouseX, mouseY, mouseEvent, l2, i1)) {
    ...
    public boolean mouseReleased(int p_148181_1_, int p_148181_2_, int p_148181_3_) {
        for (int i = 0; i < this.getSize(); ++i) {
            ...
            this.getListEntry(i).mouseReleased(i, p_148181_1_, p_148181_2_, p_148181_3_, l2, i1);
        }

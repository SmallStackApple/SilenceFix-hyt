...
extends GuiScreen {
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        if (ChatAllowedCharacters.isAllowedCharacter(typedChar) && this.fontRendererObj.getStringWidth(s2 + typedChar) <= 90) {
            s2 = s2 + typedChar;
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiEditSign.drawCenteredString(this.fontRendererObj, I18n.format("sign.edit", new Object[0]), this.width / 2, 40, 0xFFFFFF);

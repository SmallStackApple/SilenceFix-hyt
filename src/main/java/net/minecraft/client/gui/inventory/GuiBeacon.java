...
extends GuiContainer {
    ...
    public void updateScreen() {
        ...
        if (this.buttonsNotDrawn && i >= 0) {
            ...
            int i2 = 3;
            int j22 = TileEntityBeacon.effectsList[i2].length + 1;
            int k22 = j22 * 22 + (j22 - 1) * 2;
            for (int l2 = 0; l2 < j22 - 1; ++l2) {
                int i3 = TileEntityBeacon.effectsList[i2][l2].id;
                PowerButton guibeacon$powerbutton2 = new PowerButton(i2 << 8 | i3, this.guiLeft + 167 + l2 * 24 - k22 / 2, this.guiTop + 47, i3, i2);
            ...
            if (j2 > 0) {
                PowerButton guibeacon$powerbutton1 = new PowerButton(i2 << 8 | j2, this.guiLeft + 167 + (j22 - 1) * 24 - k22 / 2, this.guiTop + 47, j2, i2);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        this.itemRender.renderItemAndEffectIntoGUI(new ItemStack(Items.emerald), i + 42, j2 + 109);
        this.itemRender.renderItemAndEffectIntoGUI(new ItemStack(Items.diamond), i + 42 + 22, j2 + 109);
        this.itemRender.renderItemAndEffectIntoGUI(new ItemStack(Items.gold_ingot), i + 42 + 44, j2 + 109);
        this.itemRender.renderItemAndEffectIntoGUI(new ItemStack(Items.iron_ingot), i + 42 + 66, j2 + 109);
    ...
    extends GuiButton {
        ...
        public void drawButton(Minecraft mc, int mouseX, int mouseY) {
            if (this.visible) {
                ...
                this.drawTexturedModalRect(this.xPosition, this.yPosition, j2, i, this.width, this.height);

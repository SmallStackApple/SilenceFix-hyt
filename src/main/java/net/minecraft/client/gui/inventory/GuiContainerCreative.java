...
extends InventoryEffectRenderer {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        if (mouseButton == 0) {
            ...
            for (CreativeTabs creativetabs : CreativeTabs.creativeTabArray) {
                if (!this.func_147049_a(creativetabs, i, j2)) continue;
                return;
            }
        }
    ...
    public void handleMouseInput() throws IOException {
        ...
        if (i != 0 && this.needsScrollBars()) {
            ...
            this.currentScroll = (float)((double)this.currentScroll - (double)i / (double)j2);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (creativetabs.shouldHidePlayerInventory()) {
            this.drawTexturedModalRect(i, j2 + (int)((float)(k2 - j2 - 17) * this.currentScroll), 232 + (this.needsScrollBars() ? 0 : 12), 0, 12, 15);
        }
    ...
    extends Container {
        ...
        public ContainerCreative(EntityPlayer p_i1086_1_) {
            ...
            for (int i = 0; i < 5; ++i) {
                for (int j2 = 0; j2 < 9; ++j2) {
                    this.addSlotToContainer(new Slot(field_147060_v, i * 9 + j2, 9 + j2 * 18, 18 + i * 18));
                }
            }
        ...
        public void scrollTo(float p_148329_1_) {
            ...
            int j2 = (int)((double)(p_148329_1_ * (float)i) + 0.5);
            if (j2 < 0) {
                j2 = 0;
            }

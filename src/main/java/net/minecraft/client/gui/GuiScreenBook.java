...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        int j2 = 2;
        this.buttonNextPage = new NextPageButton(1, i + 120, j2 + 154, true);
        this.buttonList.add(this.buttonNextPage);
        this.buttonPreviousPage = new NextPageButton(2, i + 38, j2 + 154, false);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int i = (this.width - this.bookImageWidth) / 2;
        int j2 = 2;
        this.drawTexturedModalRect(i, j2, 0, 0, this.bookImageWidth, this.bookImageHeight);
        if (this.bookGettingSigned) {
            ...
            this.fontRendererObj.drawString(s1, i + 36 + (116 - k2) / 2, j2 + 16 + 16, 0);
            int l2 = this.fontRendererObj.getStringWidth(s2);
            this.fontRendererObj.drawString(s2, i + 36 + (116 - l2) / 2, j2 + 48, 0);
            String s22 = I18n.format("book.byAuthor", this.editingPlayer.getName());
            int i1 = this.fontRendererObj.getStringWidth(s22);
            this.fontRendererObj.drawString((Object)((Object)EnumChatFormatting.DARK_GRAY) + s22, i + 36 + (116 - i1) / 2, j2 + 48 + 10, 0);
            String s3 = I18n.format("book.finalizeWarning", new Object[0]);
            this.fontRendererObj.drawSplitString(s3, i + 36, j2 + 80, 116, 0);
        } else {
            ...
            this.fontRendererObj.drawString(s4, i - j1 + this.bookImageWidth - 44, j2 + 16, 0);
            if (this.field_175386_A == null) {
                this.fontRendererObj.drawSplitString(s5, i + 36, j2 + 16 + 16, 116, 0);
            } else {
                ...
                for (int l1 = 0; l1 < k1; ++l1) {
                    ...
                    this.fontRendererObj.drawString(ichatcomponent2.getUnformattedText(), i + 36, j2 + 16 + 16 + l1 * this.fontRendererObj.FONT_HEIGHT, 0);
                }
    ...
    public IChatComponent func_175385_b(int p_175385_1_, int p_175385_2_) {
        ...
        if (i >= 0 && j2 >= 0) {
            ...
            if (i <= 116 && j2 < this.mc.fontRendererObj.FONT_HEIGHT * k2 + k2) {
    ...
    extends GuiButton {
        ...
        public void drawButton(Minecraft mc, int mouseX, int mouseY) {
            if (this.visible) {
                ...
                this.drawTexturedModalRect(this.xPosition, this.yPosition, i, j2, 23, 13);
            }
        }
    }
}

...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiYesNo.drawCenteredString(this.fontRendererObj, this.messageLine1, this.width / 2, 70, 0xFFFFFF);
        int i = 90;
        for (String s2 : this.field_175298_s) {
            GuiYesNo.drawCenteredString(this.fontRendererObj, s2, this.width / 2, i, 0xFFFFFF);

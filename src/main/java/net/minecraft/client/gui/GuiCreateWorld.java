...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, midWidth - 155, this.height - 28, 150, 20, I18n.format("selectWorld.create", new Object[0])));
        this.buttonList.add(new GuiButton(1, midWidth + 5, this.height - 28, 150, 20, I18n.format("gui.cancel", new Object[0])));
        this.btnGameMode = new GuiButton(2, midWidth - 75, 115, 150, 20, I18n.format("selectWorld.gameMode", new Object[0]));
        this.buttonList.add(this.btnGameMode);
        this.btnMoreOptions = new GuiButton(3, midWidth - 75, 187, 150, 20, I18n.format("selectWorld.moreWorldOptions", new Object[0]));
        this.buttonList.add(this.btnMoreOptions);
        this.btnMapFeatures = new GuiButton(4, midWidth - 155, 100, 150, 20, I18n.format("selectWorld.mapFeatures", new Object[0]));
        this.buttonList.add(this.btnMapFeatures);
        this.btnMapFeatures.visible = false;
        this.btnBonusItems = new GuiButton(7, midWidth + 5, 151, 150, 20, I18n.format("selectWorld.bonusItems", new Object[0]));
        this.buttonList.add(this.btnBonusItems);
        this.btnBonusItems.visible = false;
        this.btnMapType = new GuiButton(5, midWidth + 5, 100, 150, 20, I18n.format("selectWorld.mapType", new Object[0]));
        this.buttonList.add(this.btnMapType);
        this.btnMapType.visible = false;
        this.btnAllowCommands = new GuiButton(6, midWidth - 155, 151, 150, 20, I18n.format("selectWorld.allowCommands", new Object[0]));
        this.buttonList.add(this.btnAllowCommands);
        this.btnAllowCommands.visible = false;
        this.btnCustomizeType = new GuiButton(8, midWidth + 5, 120, 150, 20, I18n.format("selectWorld.customizeType", new Object[0]));
    ...
    public static String getUncollidingSaveDirName(ISaveFormat saveLoader, String name) {
        ...
        for (String s2 : disallowedFilenames) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiCreateWorld.drawCenteredString(this.fontRendererObj, I18n.format("selectWorld.create", new Object[0]), midWidth, 20, -1);
        if (this.inMoreWorldOptionsDisplay) {
            this.drawString(this.fontRendererObj, I18n.format("selectWorld.enterSeed", new Object[0]), midWidth - 100, 47, -6250336);
            this.drawString(this.fontRendererObj, I18n.format("selectWorld.seedInfo", new Object[0]), midWidth - 100, 85, -6250336);
            if (this.btnMapFeatures.visible) {
                this.drawString(this.fontRendererObj, I18n.format("selectWorld.mapFeatures.info", new Object[0]), midWidth - 150, 122, -6250336);
            }
            if (this.btnAllowCommands.visible) {
                this.drawString(this.fontRendererObj, I18n.format("selectWorld.allowCommands.info", new Object[0]), midWidth - 150, 172, -6250336);
            }
            ...
            this.drawString(this.fontRendererObj, I18n.format("selectWorld.enterName", new Object[0]), midWidth - 100, 47, -6250336);
            this.drawString(this.fontRendererObj, I18n.format("selectWorld.resultFolder", new Object[0]) + " " + this.saveDirName, midWidth - 100, 85, -6250336);

...
extends GuiContainer {
    ...
    public void initGui() {
        ...
        this.nextButton = new MerchantButton(1, i + 120 + 27, j2 + 24 - 1, true);
        this.buttonList.add(this.nextButton);
        this.previousButton = new MerchantButton(2, i + 36 - 19, j2 + 24 - 1, false);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (merchantrecipelist != null && !merchantrecipelist.isEmpty()) {
            ...
            this.itemRender.renderItemAndEffectIntoGUI(itemstack, i + 36, j2 + 24);
            this.itemRender.renderItemOverlays(this.fontRendererObj, itemstack, i + 36, j2 + 24);
            if (itemstack1 != null) {
                this.itemRender.renderItemAndEffectIntoGUI(itemstack1, i + 62, j2 + 24);
                this.itemRender.renderItemOverlays(this.fontRendererObj, itemstack1, i + 62, j2 + 24);
            }
            this.itemRender.renderItemAndEffectIntoGUI(itemstack2, i + 120, j2 + 24);
            this.itemRender.renderItemOverlays(this.fontRendererObj, itemstack2, i + 120, j2 + 24);

...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(114514,5,5,98,20,"更换背景图片"));
        this.buttonList.add(new GuiButton(1919810,5,5 + 20 + 4,98,20,(BackgroundTextureManager.isRefreshing() ? "开启" : "关闭" )+ "自动刷新图片"));
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
        ...
        this.buttonList.add(new GuiButton(1337, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "AltManager"));
    }
    /**
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 1919810) {
            BackgroundTextureManager.toggleRefreshing(1000);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      BackgroundTextureManager.renderBackground();
        ...
        RenderUtil.drawImage(logo,sw/2 - 128/2,this.height / 4 + 58 - 128,128,128);

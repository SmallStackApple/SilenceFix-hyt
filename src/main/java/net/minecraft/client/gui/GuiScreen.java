...
implements GuiYesNoCallback {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (SilenceFix.instance.uiManager != null) {
            SilenceFix.instance.uiManager.mouseX = mouseX;
            SilenceFix.instance.uiManager.mouseY = mouseY;
        }
    }
...
//            this.drawBackground(tint);
    ...
    public void renderBackground() {
        ...
        RenderUtil.drawImage(new ResourceLocation("express/bg.png"),0,0,width,height);
    }
}

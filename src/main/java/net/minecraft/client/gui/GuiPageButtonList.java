...
extends GuiListExtended {
    ...
    public void func_178062_a(char p_178062_1_, int p_178062_2_) {
        block1: {
            ...
            block2: {
                ...
                block3: {
                    ...
                    block4: {
                        ...
                        int k2 = this.field_178072_w.indexOf(this.field_178075_A);
                        k2 = GuiScreen.isShiftKeyDown() ? (k2 == 0 ? this.field_178072_w.size() - 1 : --k2) : (k2 == this.field_178072_w.size() - 1 ? 0 : ++k2);
                        this.field_178075_A = this.field_178072_w.get(k2);
                        guitextfield = (GuiTextField)this.field_178075_A;
            ...
            int j2 = i = this.field_178072_w.indexOf(this.field_178075_A);
            for (String s1 : astring) {
                this.field_178072_w.get(j2).setText(s1);
                j2 = j2 == this.field_178072_w.size() - 1 ? 0 : ++j2;
                if (j2 == i) break;
            }
        }
    }

...
import dev.xinxin.event.attack.AttackEvent;
...
public class PlayerControllerMP {
    ...
    public boolean isBreakingBlock() {
        return this.mc.gameSettings.keyBindAttack.isKeyDown() && this.mc.thePlayer.capabilities.allowEdit && this.mc.objectMouseOver.typeOfHit.equals((Object)MovingObjectPosition.MovingObjectType.BLOCK);
    }
    ...
    public boolean onPlayerRightClick(EntityPlayerSP player, WorldClient worldIn, ItemStack heldStack, BlockPos hitPos, EnumFacing side, Vec3 hitVec) {
        ...
        if (KillAura.target != null && KillAura.isBlocking) return false;

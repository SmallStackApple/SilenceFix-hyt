...
public class CrashReportCategory {
    ...
    public static String getCoordinateInfo(double x2, double y2, double z) {
        return String.format("%.2f,%.2f,%.2f - %s", x2, y2, z, CrashReportCategory.getCoordinateInfo(new BlockPos(x2, y2, z)));
    }
    ...
    public static String getCoordinateInfo(BlockPos pos) {
        ...
        try {
            stringbuilder.append(String.format("World: (%d,%d,%d)", i, j2, k2));
        }
        ...
        try {
            ...
            int k22 = (l2 + 1 << 4) - 1;
            int l22 = (i1 + 1 << 4) - 1;
            stringbuilder.append(String.format("Chunk: (at %d,%d,%d in %d,%d; contains blocks %d,0,%d to %d,255,%d)", j1, k1, l1, l2, i1, i2, j22, k22, l22));
        }
    ...
    static class Entry {
        ...
        public Entry(String key, Object value) {
            ...
            if (value == null) {
                ...
                this.ba = "~~ERROR~~ " + throwable.getClass().getSimpleName() + ": " + throwable.getMessage();
            } else {
                this.ba = value.toString();
            }
        }

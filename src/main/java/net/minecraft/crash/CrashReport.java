...
public class CrashReport {
    ...
    private void populateEnvironment() {
        ...
        this.theReportCategory.addCrashSectionCallable("Memory", new Callable<String>(){
            ...
            public String call() {
                ...
                long l2 = i / 1024L / 1024L;
                long i1 = j2 / 1024L / 1024L;
                long j1 = k2 / 1024L / 1024L;
                return k2 + " bytes (" + j1 + " MB) / " + j2 + " bytes (" + i1 + " MB) up to " + i + " bytes (" + l2 + " MB)";
            }
        });
    ...
    public CrashReportCategory makeCategoryDepth(String categoryName, int stacktraceLength) {
        ...
        if (this.firstCategoryInCrashReport) {
            ...
            int j2 = astacktraceelement.length - i;
            if (j2 < 0) {
            ...
            } else if (astacktraceelement != null && astacktraceelement.length >= i && 0 <= j2 && j2 < astacktraceelement.length) {

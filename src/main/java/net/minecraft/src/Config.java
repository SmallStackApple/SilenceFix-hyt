...
public class Config {
    ...
    public static String getVersion() {
        return "OptiFine_1.8.8_HD_U_M6_pre2";
    }
    ...
    public static GlVersion getGlVersion() {
        if (glVersion == null) {
            String s2 = GL11.glGetString((int)7938);
    ...
    public static GlVersion getGlslVersion() {
        String s2;
        if (glslVersion == null && (glslVersion = Config.parseGlVersion(s2 = GL11.glGetString((int)35724), null)) == null) {
    ...
    public static GlVersion parseGlVersion(String p_parseGlVersion_0_, GlVersion p_parseGlVersion_1_) {
        try {
            ...
            return new GlVersion(i, j2, k2, s2);
        }
        catch (Exception exception) {
    ...
    private static String[] detectOpenGlExtensions() {
        try {
            ...
            if (glversion.getMajor() >= 3 && (i = GL11.glGetInteger((int)33309)) > 0) {
                ...
                for (int j2 = 0; j2 < i; ++j2) {
                    astring[j2] = GL30.glGetStringi((int)7939, (int)j2);
                }
                return astring;
            }
        }
        ...
        try {
            String s2 = GL11.glGetString((int)7939);
    ...
    public static IResourcePack[] getResourcePacks() {
        ...
        while (iterator.hasNext()) {
            ResourcePackRepository.Entry o2;
            ResourcePackRepository.Entry resourcepackrepository$entry = o2 = iterator.next();
    ...
    public static String[] getDisplayModeNames() {
        ...
        for (int i = 0; i < adisplaymode.length; ++i) {
            ...
            astring[i] = s2 = "" + displaymode.getWidth() + "x" + displaymode.getHeight();
        }
        return astring;
    }
    ...
    public static void checkGlError(String p_checkGlError_0_) {
        ...
        if (i != 0 && GlErrors.isEnabled(i)) {
            String s2 = Config.getGlErrorString(i);
            String s1 = String.format("OpenGL error: %s (%s), at: %s", i, s2, p_checkGlError_0_);
            Config.error(s1);
            if (Config.isShowGlErrors() && TimedEvent.isActive("ShowGlError", 10000L)) {
                String s22 = I18n.format("of.message.openglError", i, s2);
                Config.minecraft.ingameGUI.getChatGUI().printChatMessage(new ChatComponentText(s22));
            }
        }
    }
    ...
    public static int compareRelease(String p_compareRelease_0_, String p_compareRelease_1_) {
        ...
        if (i != (j2 = Config.parseInt(astring1[1], -1))) {
            return i - j2;
        }
            ...
            if (!Minecraft.isRunningOnMac && Config.getDefaultResourcePack() != null) {
                ...
                block7: {
                    ...
                    try {
                        ...
                        if (inputstream == null || inputstream1 == null) break block7;
        ...
        try {
            if (minecraft.isFullScreen()) {
                ...
                if (Config.minecraft.currentScreen != null) {
                    ...
                    Config.minecraft.currentScreen.setWorldAndResolution(minecraft, i, j2);
                }
    ...
    public static Object[] addObjectsToArray(Object[] p_addObjectsToArray_0_, Object[] p_addObjectsToArray_1_) {
        ...
        int j2 = i + p_addObjectsToArray_1_.length;
    ...
    public static void drawFps() {
        ...
        String s1 = "" + i + "/" + Config.getFpsMin() + " fps, C: " + j2 + ", E: " + k2 + "+" + l2 + ", U: " + s2;
    ...
    public static int getFpsMin() {
        ...
        if (i == (j2 = frametimer.getLastIndex())) {
            return fpsMinLast;
        }
        int k2 = Minecraft.getDebugFPS();
        if (k2 <= 0) {
            k2 = 1;
        }
        long i1 = l2 = (long)(1.0 / (double)k2 * 1.0E9);
        long j1 = 0L;
        int k1 = MathHelper.normalizeAngle(i - 1, along.length);
        while (k1 != j2 && (double)j1 < 1.0E9) {
            long l1 = along[k1];
            if (l1 > i1) {
                i1 = l1;
            }
    ...
    private static String getUpdates(String p_getUpdates_0_) {
        ...
        int j2 = p_getUpdates_0_.indexOf(32, i);
        return j2 < 0 ? "" : p_getUpdates_0_.substring(i + 1, j2);
    }

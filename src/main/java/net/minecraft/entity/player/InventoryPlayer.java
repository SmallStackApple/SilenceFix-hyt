...
implements IInventory {
    ...
    public int clearMatchingItems(Item itemIn, int metadataIn, int removeCount, NBTTagCompound itemNBT) {
        ...
        for (int j2 = 0; j2 < this.mainInventory.length; ++j2) {
            ...
            int k2 = removeCount <= 0 ? itemstack.stackSize : Math.min(removeCount - i, itemstack.stackSize);
            i += k2;
    ...
    private int storePartialItemStack(ItemStack itemStackIn) {
        ...
        int k2 = i;
        if (i > this.mainInventory[j2].getMaxStackSize() - this.mainInventory[j2].stackSize) {

...
IInventory {
    ...
    private void updateSegmentColors() {
        ...
        for (int i1 = k2 + 1; i1 < 256; ++i1) {
            float[] afloat;
            IBlockState iblockstate = this.worldObj.getBlockState(blockpos$mutableblockpos.set(j2, i1, l2));
    ...
    public int func_183001_h(int p_183001_1_) {

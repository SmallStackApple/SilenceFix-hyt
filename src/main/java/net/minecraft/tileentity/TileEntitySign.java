...
extends TileEntity {
    ...
    public void writeToNBT(NBTTagCompound compound) {
        ...
        for (int i = 0; i < 4; ++i) {
            String s2 = IChatComponent.Serializer.componentToJson(this.signText[i]);
            compound.setString("Text" + (i + 1), s2);
        }
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        for (int i = 0; i < 4; ++i) {
            String s2 = compound.getString("Text" + (i + 1));
            try {
                ...
                this.signText[i] = new ChatComponentText(s2);
            }
        }

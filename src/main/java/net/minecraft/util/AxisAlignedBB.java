...
public class AxisAlignedBB {
    ...
    public AxisAlignedBB addCoord(double x2, double y2, double z) {
        double d0 = this.minX;
        double d1 = this.minY;
        double d2 = this.minZ;
        double d3 = this.maxX;
    ...
    public AxisAlignedBB expand(double x2, double y2, double z) {
    ...
    public AxisAlignedBB offset(double x2, double y2, double z) {
        return new AxisAlignedBB(this.minX + x2, this.minY + y2, this.minZ + z, this.maxX + x2, this.maxY + y2, this.maxZ + z);
    }
    ...
    public AxisAlignedBB contract(double x2, double y2, double z) {
        double d0 = this.minX + x2;
        double d1 = this.minY + y2;
        double d2 = this.minZ + z;
        double d3 = this.maxX - x2;

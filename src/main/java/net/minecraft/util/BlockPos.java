...
extends Vec3i {
    ...
    public BlockPos(int x2, int y2, int z) {
        super(x2, y2, z);
    }

    public BlockPos(double x2, double y2, double z) {
        super(x2, y2, z);
    }
    ...
    public BlockPos add(double x2, double y2, double z) {
        return x2 == 0.0 && y2 == 0.0 && z == 0.0 ? this : new BlockPos((double)this.getX() + x2, (double)this.getY() + y2, (double)this.getZ() + z);
    }

    public BlockPos add(int x2, int y2, int z) {
        return x2 == 0 && y2 == 0 && z == 0 ? this : new BlockPos(this.getX() + x2, this.getY() + y2, this.getZ() + z);
    }
            ...
            public Iterator<BlockPos> iterator() {
                return new AbstractIterator<BlockPos>(){
                    ...
                    protected BlockPos computeNext() {
                        ...
                        this.lastReturned = new BlockPos(i, j2, k2);
                        return this.lastReturned;
                    }
                };
            }

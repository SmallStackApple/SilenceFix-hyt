...
public class MathHelper {
    ...
    public static int func_180188_d(int p_180188_0_, int p_180188_1_) {
        ...
        int k1 = (int)((float)i * (float)j2 / 255.0f);
    ...
    public static long getCoordinateRandom(int x2, int y2, int z) {
        long i = (long)(x2 * 3129871) ^ (long)z * 116129781L ^ (long)y2;
    ...
    static {
        ...
        for (int j2 = 0; j2 < SIN_TABLE_FAST.length; ++j2) {
            MathHelper.SIN_TABLE_FAST[j2] = MathUtils.roundToFloat(Math.sin((double)j2 * Math.PI * 2.0 / 4096.0));
        }
        ...
        for (int k2 = 0; k2 < 257; ++k2) {
            double d0 = (double)k2 / 256.0;
            double d1 = Math.asin(d0);
            MathHelper.field_181165_f[k2] = Math.cos(d1);
            MathHelper.field_181164_e[k2] = d1;
        }
    }
}

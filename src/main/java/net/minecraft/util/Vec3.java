...
public class Vec3 {
    ...
    public Vec3(double x2, double y2, double z) {
        if (x2 == -0.0) {
            x2 = 0.0;
        }
        if (y2 == -0.0) {
    ...
    public Vec3 subtract(double x2, double y2, double z) {
        return this.addVector(-x2, -y2, -z);
    }
    ...
    public Vec3 addVector(double x2, double y2, double z) {
        return new Vec3(this.xCoord + x2, this.yCoord + y2, this.zCoord + z);
    }

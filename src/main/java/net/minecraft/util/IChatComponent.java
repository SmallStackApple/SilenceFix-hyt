        ...
        public IChatComponent deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
            ...
            if (jsonobject.has("text")) {
                ...
                if (jsonobject.has("with")) {
                    ...
                    ichatcomponent = new ChatComponentTranslation(s2, aobject);
                } else {
                    ichatcomponent = new ChatComponentTranslation(s2, new Object[0]);
                }
            ...
            if (jsonobject.has("extra")) {
                ...
                for (int j2 = 0; j2 < jsonarray2.size(); ++j2) {
                    ichatcomponent.appendSibling(this.deserialize(jsonarray2.get(j2), p_deserialize_2_, p_deserialize_3_));
                }
            }

...
extends EntityDamageSource {
    ...
    public IChatComponent getDeathMessage(EntityLivingBase entityLivingBaseIn) {
        ...
        String s1 = s2 + ".item";
        return itemstack != null && itemstack.hasDisplayName() && StatCollector.canTranslate(s1) ? new ChatComponentTranslation(s1, entityLivingBaseIn.getDisplayName(), ichatcomponent, itemstack.getChatComponent()) : new ChatComponentTranslation(s2, entityLivingBaseIn.getDisplayName(), ichatcomponent);
    }
}

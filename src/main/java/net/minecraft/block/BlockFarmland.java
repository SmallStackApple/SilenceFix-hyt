...
public class BlockFarmland extends Block
{
    ...
    {
        if (ViaLoadingBase.getInstance().getTargetVersion().getVersion() >= 47 && SilenceFix.instance.moduleManager.getModule(PacketFix.class).getState()) {
            return new AxisAlignedBB(pos.getX(), pos.getY(), pos.getZ(), pos.getX() + 1, pos.getY() + 0.9375, pos.getZ() + 1);
        } else {

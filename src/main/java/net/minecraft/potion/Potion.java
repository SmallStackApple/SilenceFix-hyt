...
public class Potion {
    ...
    public void affectEntity(Entity p_180793_1_, Entity p_180793_2_, EntityLivingBase entityLivingBaseIn, int p_180793_4_, double p_180793_5_) {
        if (!(this.id == Potion.heal.id && !entityLivingBaseIn.isEntityUndead() || this.id == Potion.harm.id && entityLivingBaseIn.isEntityUndead())) {
            if (this.id == Potion.harm.id && !entityLivingBaseIn.isEntityUndead() || this.id == Potion.heal.id && entityLivingBaseIn.isEntityUndead()) {
                int j2 = (int)(p_180793_5_ * (double)(6 << p_180793_4_) + 0.5);
                if (p_180793_1_ == null) {
                    entityLivingBaseIn.attackEntityFrom(DamageSource.magic, j2);
                } else {
                    entityLivingBaseIn.attackEntityFrom(DamageSource.causeIndirectMagicDamage(p_180793_1_, p_180793_2_), j2);
                }
            }
        } else {
    ...
    public boolean isReady(int p_76397_1_, int p_76397_2_) {
        if (this.id == Potion.regeneration.id) {
            int k2 = 50 >> p_76397_2_;
            return k2 > 0 ? p_76397_1_ % k2 == 0 : true;
        }
        if (this.id == Potion.poison.id) {
            int j2 = 25 >> p_76397_2_;
            return j2 > 0 ? p_76397_1_ % j2 == 0 : true;
        }

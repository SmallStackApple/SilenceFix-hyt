...
public class CustomChunkMethod {
    public static final String field_3939;
    private static final byte[] field_3603;
    public static final Base32 field_3805;
    public static final String field_1323;
    public static final String field_1716;
    public static final String field_2006;
    public static final String field_1039;

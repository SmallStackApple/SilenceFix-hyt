...
import dev.xinxin.utils.client.menu.NormalMainMenu;
import dev.xinxin.utils.waveycapes.util.Matrix4f;
...
//import net.minecraft.client.gui.BetterMainMenu;
...
public class Reflector
{
    ...
    public static ReflectorClass BetterMainMenu = new ReflectorClass(BetterMainMenu.class);
    public static ReflectorField BetterMainMenu_splashText = new ReflectorField(BetterMainMenu, String.class);
